    ...
    return (
      ...
      >
        <div className="p-5 md:p-8 h-full flex flex-col mt-4 md:mt-12">
          ...
          <p className={`text-sm md:text-lg ${descriptionColor} leading-relaxed`}>{description}</p>
        </div>
      </div>
    )
  }
  ...
  const featureItems = [
    {
      ...
      image: "/src/assets/icons/flower.svg",
      description:
    ...
    },
    {
      ...
      description: "We save you money, time and streamline the procurement of fresh produce",
