      ...
      <div className="bg-white shadow-lg rounded-2xl overflow-hidden max-w-5xl w-full grid md:grid-cols-2">
        ...
        <div className="p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gray-400 text-white py-2 rounded-md text-sm font-medium hover:bg-green-700 transition"
            >
              Sign Up
            </button>
            ...
            <div className="flex gap-3">
              <button
                type="button"
                className="flex items-center justify-center w-full border rounded-md py-2 hover:bg-gray-50"
              >
            ...
            <p className="text-xs text-center mt-4">
              ...
              <Link to="/SignInForm" className="text-purple-600 font-semibold">
                Sign in
              </Link>
            </p>
          </form>
