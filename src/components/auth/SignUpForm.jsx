...
const SignUpForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!isPhoneValid) newErrors.phone = 'Please enter a valid phone number or email address.';
  ...
  return (
    <div className="w-full h-screen  flex flex-col lg:flex-row items-center bg-white">
        ...
        <div className="w-full lg:max-w-[35%] h-full flex items-center justify-center overflow-hidden">
          <img src={isMobile ? MobileBg : DesktopBgSignUp} 
          alt="Sign Up" 
        ...
        {/* Right form */}
        <div className="w-full absolute top-[50%] rounded-t-xl bg-white p-6  md:flex md:items-center md:justify-center 
          ...
          <div className="w-full max-w-2xl flex flex-col justify-between bg-white py-3 space-y-4">
            ...
            <form onSubmit={handleSubmit} className="w-full h-auto mt-6">
              {/* Phone/Email */}
              <div>
                <label className="block font-semibold text-base">Phone number or Email</label>
                <div className="flex">
                  <Dropdown
                    countries={countries}
                  ...
                  <input
                    ...
                    className={`border mb-3 p-2.5 rounded-lg placeholder:text-base placeholder:text-[#98A2B3] relative z-10 w-full cursor-pointer ${
                      touched.phone && errors.phone ? "border-red-500" : "border-[#DDD5DD]"
                    }`}
                  />
                </div>
                ...
                <div className="flex items-center border border-gray-300 rounded-md px-3">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      const newErrors = validateForm();
                      setErrors((prev) => ({ ...prev, confirmPassword: newErrors.confirmPassword }));
                    }}
                    onBlur={() => {
              ...
              <div className="flex items-start justify-between gap-2 mt-4 font-medim text-sm">
                ...
                />
                <label htmlFor="agree" className="text-gray-500 text-sm font-medium">
                  By signing up, you acknowledge that you have read and agree to 
                  be bound by our{" "}
                  <a href="/terms" target="_blank" rel="noopener noreferrer" className="text-[#FFA725]">
                    Terms & Conditions
                  </a>{" "}
                  and{" "}
                  <a href="/privacy" target="_blank" rel="noopener noreferrer" className="text-[#FFA725]">
                    Privacy Policy
                  </a>.
                </label>
              </div>
            ...
            <div className="flex justify-center items-center gap-7 font-normal text-base">
              {isMobile ? (
                ...
                <>
                  <button type="button" className="w-[400px] h-12 flex items-center justify-center gap-3 border border-[#3C3C3C] rounded-lg">
            ...
            <p className="font-rubik text-center text-base font-normal mt-5">
              ...
              <Link to="/Sign-in" className="text-[#FFA725] cursor-pointer font-medium">Sign In</Link>
            </p>
          </div>
        </div>
    </div>
