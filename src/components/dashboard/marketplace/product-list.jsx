            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3 pt-3">
                ...
                {product.availability === "in_stock" ? (
                  <p className="text-xs text-green-700 py-1 px-2 rounded-md bg-green-100">
                    In stock
                  </p>
                ) : (
                  <p className="text-sm text-red-700 p-3 rounded-md bg-red-100">
                    Out of stock
                  </p>
                )}
              </div>
