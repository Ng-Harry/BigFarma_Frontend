                ...
                <Link key={product.id} to={`/products/${product.id}`}>
                    <div className="p-4 bg-white shadow rounded-md">
                        <img
                            ...
                            alt={product.name}
                            className="w-full h-48 rounded-t-md bg-slate-100 flex items-center justify-center"
                        />
                        {/* details  */}
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-3 pt-3">
                                ...
                                {product.availability === "in_stock" ? <p className="text-xs text-green-700 py-1 px-2 rounded-md bg-green-100">In stock</p> : <p className="text-sm text-red-700 p-3 rounded-md bg-red-100">Out of stock</p>}
                            </div>

                            {/* price  */}
                            <div className="flex items-center gap-1">
                                <p className="font-semibold">₦{product.price}</p>
                                <p className="font-normal text-sm">per {product.quantity.split(" ")[1]}</p>
                            </div>
                            { /* rating  */}
